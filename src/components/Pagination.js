    ...
    return (
      <nav aria-label="Search characters pages">
        <ul className="pagination">
          <li className="page-item previous" onClick={this.handleNumberClick} ><a className="page-link" href="#">Previous</a></li>
          ...
          <li className="page-item next" onClick={this.handleNumberClick} ><a className="page-link" href="#">Next</a></li>
        </ul>
      </nav>
    )
  }
